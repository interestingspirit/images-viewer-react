  ...
  render() {
    ...
    return (
      <div>
        ...
        <button
          id='viewer-tester-change-btn'
          onClick={this.handleChangeActiveIndex}
        >
          change active index
        </button>
        <button
          id='viewer-tester-change-images-btn'
          onClick={this.handleChangeImages}
        >
          change images
        </button>
        <div
...
describe('Viewer', () => {
  ...
  it('change active index success', () => {
    ...
    expect($$('.images-viewer-react-attribute')[0].innerHTML).toContain(
      'mountain',
    )
  })
  ...
  it('reset img when change images', () => {
    ...
    viewerHelper.open()
    expect($$('.images-viewer-react-img-details')[0].innerHTML).toBe(
      '(100 x 100)',
    )
    setGetImageSize(() => 200)
