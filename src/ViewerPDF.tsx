  ...
  translateX(${props.left !== null ? props.left + 'px' : 'aoto'}) translateY(${props.top}px)
    ...
    return (
      <div className='print-container' ref={containerRef}>
        <img className={imgClass} src={props.imgSrc} style={imgStyle} onMouseDown={props.handleMouseDown} />
      </div>
    )
  }
}

export default forwardRef<ViewerRef, ViewerPDFProps>(memo(ViewerPDF))
